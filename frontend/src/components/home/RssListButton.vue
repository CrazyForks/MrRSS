...
<template>
  <nav>
    ...
    <div class="function">
      <button class="btn" @click="$emit('handle-click-refresh')" :title="$t('Home.RssListButton.refresh')">
      ...
      <button class="btn" @click="goToSettings" :title="$t('Home.RssListButton.setting')">
...
@import '../../styles/home/RssListButton.scss';
</style>